...
public class LinkedListExample {
    public static void main(String[] args) {
        ...
        // 15. addFirst(E e) - Adds element at the beginning
        list.addFirst("Pineapple");

        // 16. addLast(E e) - Adds element at the end
        list.addLast("Grapes");

        // 17. removeFirst() - Removes first element
        list.removeFirst();

        // 18. removeLast() - Removes last element
        list.removeLast();

        // 19. getFirst() - Retrieves first element
        System.out.println("First Element: " + list.getFirst());

        // 20. getLast() - Retrieves last element
